...
$(document).ready(function(){
    ...
    if($("#filetree").length > 0){
        ...
        $("#filetree").fileTree({
            root: '/',
            script: adminThemePath+'/js/assets/filetree/jqueryFileTree.php',
            expandSpeed: 200,
            collapseSpeed: 200,
            multiFolder: false
        }, function(file) {
    ...
    if($("#pluploader").length > 0){
        ...
        $("#pluploader").pluploadQueue({runtimes : 'html5',
                                        url :adminThemePath+'/js/assets/plupload.php',
                                        max_file_size : '1mb',
                                        chunk_size : '1mb',
                                        unique_names : true,
                                        dragdrop : true,
    ...
    if($("#calendar").length > 0){
        ...
        var calendar = $('#calendar').fullCalendar({
            ...
            editable: true,
            events: {url: adminThemePath+"/js/assets/ajax_fullcalendar.php",
                     success: function(){
